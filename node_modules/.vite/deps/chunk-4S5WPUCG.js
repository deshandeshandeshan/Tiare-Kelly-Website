...
// node_modules/@sanity/client/dist/_chunks/browserMiddleware--4iEqxOv.js
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-D3O62d5b-HEIZCW47.js").then(function(n) {
...
function _dataRequest(client, httpRequest, endpoint, body, options = {}) {
  ...
  const { timeout: timeout2, token, tag, headers, returnQuery } = options;
...
function _listen(query, params, opts = {}) {
  ...
  return new Observable((observer) => {
    ...
    async function getEventSource() {
      const { default: EventSource } = await import("./browser-7CX2PNU7.js");
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4S5WPUCG.js.map
